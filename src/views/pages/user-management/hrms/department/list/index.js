...
// ** Table Header
const CustomHeader = ({ toggleSidebar, handlePerPage, rowsPerPage, handleFilter, searchTerm, store, currentDivision, setCurrentDivision}) => {
        ...
        <Col xl='2' className='d-flex align-items-center p-0'>
          <div className='d-flex align-items-center mb-sm-0 mb-1 me-1'>
            <Select
              ...
              className='react-select ms-50 w-100'
...
const DepartmentList = () => {
  ...
  }, [dispatch, sort, sortColumn, currentPage, rowsPerPage, searchTerm, currentDivision])
